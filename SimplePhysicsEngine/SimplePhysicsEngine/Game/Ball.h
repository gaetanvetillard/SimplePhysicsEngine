...
typedef struct Spring_s
{
    ...
    /// @brief Type de ressort : 0 normal, 1 bambou
    int type;
} Spring;
...
struct Ball_s
{
    /// @brief Type de la balle entre 0 et 4.
    int type;
    ...
    /// @brief Nombre max de ressorts lors de l'apparition de la balle.
    int springMax;

    /// @brief Force en N/m du ressort
    float springForce;
...
/// @param[in] type le type de ressort
...
/// @param type type de ressort 0 normal 1 bambou
